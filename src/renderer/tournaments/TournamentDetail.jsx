...
import { useAgentIcons, useAgentsData } from '../data/agentIcons.js';
...
import AccountPickerModal from '../account/AccountPickerModal.jsx';
import Button from '../ui/Button';
import CollapsibleCard from '../ui/CollapsibleCard.jsx';
import { TournamentDetailSkeleton } from '../ui/skeletons.jsx';
  ...
  return (
    <div className="tournament-detail">
      <div className="tournament-detail-toolbar">
        ...
        <Button variant="ghost" className="strategy-tool" onClick={handleShare} disabled={sharing}>
